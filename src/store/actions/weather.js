...
export const fetchCurrentWeather = (location, conversion) => {
    return dispatch => {
        ...
        axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${location}&units=${conversion}&appid=8583135f95e725367f6ffea8d5ad8746`)
            .then(res => {
...
export const fetchWeeklyWeather = (coordinates, conversion) => {
    return dispatch => {
        ...
        axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${coordinates.lat}&lon=${coordinates.lon}&exclude=minutely&units=${conversion}&appid=8583135f95e725367f6ffea8d5ad8746`)
            .then(res => {
